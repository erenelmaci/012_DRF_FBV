...
from .views import home, student_list, student_create, student_detail, student_update, student_delete, student_list_create, student_put_get_delete
...
urlpatterns = [
    ...
    path('student_put_get_delete/<int:pk>', student_put_get_delete),
]
